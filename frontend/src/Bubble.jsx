...
function Bubble(props) {
    ...
    let sentClassName = props.sent ? "chat-bubble-sent" : "chat-bubble-received";
    let firstClassName = props.first ? "chat-bubble-first" : ""
    let lastClassName = props.last ? "chat-bubble-last" : ""
    let justification = props.sent ? "justify-content-end" : "justify-content-start"
    let bgColor = props.sent ? "bg-primary" : "bg-secondary"
