...
class TestApi(unittest.TestCase):
    ...
    def test_get_chats_user_2(self):
        expected_num = 4
        expected_chat_1 = {'id': 2, 'name': 'ANOTHER CHAT', 'last_message': 'helloooo', 'last_sent': '2020-10-03T00:00:01'}
        expected_chat_2 = {'id': 1, 'name': 'OUR CHAT', 'last_message': 'hey whats up, welcome to the chat', 'last_sent': '1919-10-03T00:00:01'}
        expected_chat_3 = {'id': 1, 'name': 'devan', 'last_message': 'Just testing out this app', 'last_sent': '1923-09-03T00:00:01'}
        expected_chat_4 = {'id': 3, 'name': 'james', 'last_message': 'dont talk to me', 'last_sent': '1920-10-04T00:00:01'}
    ...
    def test_get_chats_user_3(self):
        expected_num = 4
        expected_chat_1 = {'id': 2, 'name': 'ANOTHER CHAT', 'last_message': 'helloooo', 'last_sent': '2020-10-03T00:00:01'}
        expected_chat_2 = {'id': 2, 'name': 'Bob', 'last_message': 'dont talk to me', 'last_sent': '1920-10-04T00:00:01'}
        expected_chat_3 = {'id': 1, 'name': 'OUR CHAT', 'last_message': 'hey whats up, welcome to the chat', 'last_sent': '1919-10-03T00:00:01'}
        expected_chat_4 = {'id': 1, 'name': 'devan', 'last_message': 'hello', 'last_sent': '1921-10-03T00:00:01'}
